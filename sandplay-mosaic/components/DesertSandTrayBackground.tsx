...
export default function DesertSandTrayBackground() {
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden pointer-events-none -z-10 bg-gradient-to-br from-[#fffaf0] via-[#fff8e7] to-[#fff5f5]">
      {/* Light pink tide with thin mint blue boundary - random fading */}
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(50px)' }}>
        <defs>
          <linearGradient id="pinkMintTide1" x1="0%" y1="50%" x2="100%" y2="50%">
            <stop offset="0%" stopColor="rgba(255, 182, 193, 0.9)" />
            <stop offset="40%" stopColor="rgba(255, 218, 185, 0.85)" />
            <stop offset="70%" stopColor="rgba(255, 228, 196, 0.8)" />
            <stop offset="88%" stopColor="rgba(255, 250, 205, 0.7)" />
            <stop offset="100%" stopColor="rgba(255, 253, 208, 0.85)" />
          </linearGradient>
        </defs>

        <motion.path
          d="M-400,200 Q-100,150 200,180 T800,160 Q1100,150 1400,190 L1400,450 Q1100,380 800,420 T200,440 Q-100,460 -400,400 Z"
          fill="url(#pinkMintTide1)"
          animate={{
            d: [
          ...
          transition={{
            ...
            repeat: Infinity,
            ease: "easeInOut",
            times: [0, 0.1, 0.25, 0.35, 0.5, 0.65, 0.75, 0.85, 0.95, 1],
          }}
        />
      </svg>

      {/* Second light pink tide - random fading with offset timing */}
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(60px)' }}>
        <defs>
          <linearGradient id="pinkMintTide2" x1="100%" y1="50%" x2="0%" y2="50%">
            <stop offset="0%" stopColor="rgba(255, 253, 208, 0.85)" />
            <stop offset="12%" stopColor="rgba(255, 250, 205, 0.7)" />
            <stop offset="30%" stopColor="rgba(255, 218, 185, 0.8)" />
            <stop offset="60%" stopColor="rgba(255, 200, 180, 0.85)" />
        ...
        <motion.path
          ...
          transition={{
            ...
            repeat: Infinity,
            ease: "easeInOut",
            times: [0, 0.12, 0.28, 0.42, 0.56, 0.68, 0.78, 0.88, 0.96, 1],
          }}
        />
      </svg>

      {/* Lighter purple blue tide with thin yellow-green boundary - random fading */}
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(55px)' }}>
        <defs>
          <linearGradient id="purpleTide1" x1="0%" y1="50%" x2="100%" y2="50%">
            <stop offset="0%" stopColor="rgba(255, 182, 193, 0.7)" />
            <stop offset="30%" stopColor="rgba(255, 218, 185, 0.65)" />
            <stop offset="60%" stopColor="rgba(255, 228, 196, 0.65)" />
            <stop offset="80%" stopColor="rgba(255, 235, 205, 0.6)" />
            <stop offset="92%" stopColor="rgba(255, 250, 205, 0.6)" />
            <stop offset="96%" stopColor="rgba(255, 253, 208, 0.65)" />
            <stop offset="100%" stopColor="rgba(255, 255, 224, 0.7)" />
          </linearGradient>
        </defs>

        <motion.path
          d="M-500,550 Q-150,470 300,520 T1000,500 Q1350,490 1700,550 L1700,900 Q1350,820 1000,870 T300,890 Q-150,910 -500,850 Z"
          fill="url(#purpleTide1)"
          animate={{
            d: [
          ...
          transition={{
            ...
            repeat: Infinity,
            ease: "easeInOut",
            times: [0, 0.15, 0.25, 0.4, 0.55, 0.65, 0.75, 0.85, 0.95, 1],
          }}
        />
      </svg>

      {/* Second lighter purple blue tide - random fading with different timing */}
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(65px)' }}>
        <defs>
          <linearGradient id="purpleTide2" x1="100%" y1="50%" x2="0%" y2="50%">
            <stop offset="0%" stopColor="rgba(255, 255, 224, 0.7)" />
            <stop offset="4%" stopColor="rgba(255, 253, 208, 0.65)" />
            <stop offset="8%" stopColor="rgba(255, 250, 205, 0.6)" />
            <stop offset="20%" stopColor="rgba(255, 228, 196, 0.6)" />
            <stop offset="40%" stopColor="rgba(255, 218, 185, 0.65)" />
            <stop offset="70%" stopColor="rgba(255, 200, 180, 0.65)" />
            <stop offset="100%" stopColor="rgba(255, 182, 193, 0.7)" />
          </linearGradient>
        </defs>

        <motion.path
          d="M2000,650 Q1600,560 1200,610 T400,590 Q50,580 -300,650 L-300,1000 Q50,910 400,960 T1200,980 Q1600,970 2000,1040 Z"
          fill="url(#purpleTide2)"
          animate={{
            d: [
          ...
          transition={{
            ...
            repeat: Infinity,
            ease: "easeInOut",
            times: [0, 0.13, 0.27, 0.38, 0.52, 0.63, 0.73, 0.84, 0.94, 1],
          }}
        />
      </svg>

      {/* Additional pink wave with mint boundary - random mid layer fading */}
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(70px)' }}>
        <defs>
          <linearGradient id="pinkMintTide3" x1="50%" y1="0%" x2="50%" y2="100%">
            <stop offset="0%" stopColor="rgba(255, 182, 193, 0.85)" />
            <stop offset="50%" stopColor="rgba(255, 218, 185, 0.8)" />
            <stop offset="85%" stopColor="rgba(255, 250, 205, 0.65)" />
            <stop offset="100%" stopColor="rgba(255, 253, 208, 0.8)" />
          </linearGradient>
        </defs>
        ...
        <motion.ellipse
          ...
          transition={{
            ...
            repeat: Infinity,
            ease: "easeInOut",
            times: [0, 0.18, 0.28, 0.45, 0.58, 0.68, 0.78, 0.88, 0.96, 1],
          }}
        />
      </svg>

      {/* Additional lighter purple wave with yellow-green boundary - random mid layer fading */}
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(75px)' }}>
        <defs>
          <linearGradient id="purpleTide3" x1="50%" y1="100%" x2="50%" y2="0%">
            <stop offset="0%" stopColor="rgba(255, 182, 193, 0.65)" />
            <stop offset="50%" stopColor="rgba(255, 218, 185, 0.6)" />
            <stop offset="85%" stopColor="rgba(255, 250, 205, 0.55)" />
            <stop offset="92%" stopColor="rgba(255, 253, 208, 0.6)" />
            <stop offset="100%" stopColor="rgba(255, 255, 224, 0.65)" />
          </linearGradient>
        </defs>
        ...
        <motion.ellipse
          ...
          transition={{
            ...
            repeat: Infinity,
            ease: "easeInOut",
            times: [0, 0.14, 0.3, 0.48, 0.62, 0.72, 0.82, 0.92, 1],
          }}
        />
      </svg>
