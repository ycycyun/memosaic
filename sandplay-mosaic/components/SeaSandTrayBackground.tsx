...
export default function SeaSandTrayBackground() {
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden pointer-events-none -z-10 bg-gradient-to-br from-[#f0f7ff] via-[#f5f9ff] to-[#faf5ff]">
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(50px)' }}>
        <defs>
          <linearGradient id="seaPinkMintTide1" x1="0%" y1="50%" x2="100%" y2="50%">
            <stop offset="0%" stopColor="rgba(173, 216, 230, 0.75)" />
            <stop offset="35%" stopColor="rgba(176, 224, 230, 0.7)" />
            <stop offset="65%" stopColor="rgba(200, 220, 255, 0.65)" />
            <stop offset="85%" stopColor="rgba(230, 220, 250, 0.55)" />
            <stop offset="100%" stopColor="rgba(255, 228, 240, 0.5)" />
          </linearGradient>
        </defs>
        <motion.path
          d="M-400,200 Q-100,150 200,180 T800,160 Q1100,150 1400,190 L1400,450 Q1100,380 800,420 T200,440 Q-100,460 -400,400 Z"
          fill="url(#seaPinkMintTide1)"
          animate={{
            d: [
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(60px)' }}>
        <defs>
          <linearGradient id="seaPinkMintTide2" x1="100%" y1="50%" x2="0%" y2="50%">
            <stop offset="0%" stopColor="rgba(255, 228, 240, 0.5)" />
            <stop offset="12%" stopColor="rgba(230, 220, 250, 0.55)" />
            <stop offset="35%" stopColor="rgba(200, 220, 255, 0.65)" />
            <stop offset="65%" stopColor="rgba(176, 224, 230, 0.7)" />
            <stop offset="100%" stopColor="rgba(173, 216, 230, 0.75)" />
          </linearGradient>
        </defs>
        <motion.path
          d="M1900,280 Q1600,220 1300,260 T700,240 Q400,230 100,280 L100,520 Q400,460 700,490 T1300,480 Q1600,470 1900,530 Z"
          fill="url(#seaPinkMintTide2)"
          animate={{
            d: [
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(55px)' }}>
        <defs>
          <linearGradient id="seaPurpleTide1" x1="0%" y1="50%" x2="100%" y2="50%">
            <stop offset="0%" stopColor="rgba(173, 216, 230, 0.65)" />
            <stop offset="25%" stopColor="rgba(176, 224, 230, 0.6)" />
            <stop offset="50%" stopColor="rgba(200, 220, 255, 0.6)" />
            <stop offset="75%" stopColor="rgba(220, 210, 255, 0.55)" />
            <stop offset="90%" stopColor="rgba(235, 225, 248, 0.5)" />
            <stop offset="96%" stopColor="rgba(248, 235, 250, 0.45)" />
            <stop offset="100%" stopColor="rgba(255, 228, 240, 0.5)" />
          </linearGradient>
        </defs>
        <motion.path
          d="M-500,550 Q-150,470 300,520 T1000,500 Q1350,490 1700,550 L1700,900 Q1350,820 1000,870 T300,890 Q-150,910 -500,850 Z"
          fill="url(#seaPurpleTide1)"
          animate={{
            d: [
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(65px)' }}>
        <defs>
          <linearGradient id="seaPurpleTide2" x1="100%" y1="50%" x2="0%" y2="50%">
            <stop offset="0%" stopColor="rgba(255, 228, 240, 0.5)" />
            <stop offset="8%" stopColor="rgba(235, 225, 248, 0.5)" />
            <stop offset="25%" stopColor="rgba(220, 210, 255, 0.55)" />
            <stop offset="50%" stopColor="rgba(200, 220, 255, 0.6)" />
            <stop offset="75%" stopColor="rgba(176, 224, 230, 0.6)" />
            <stop offset="90%" stopColor="rgba(173, 216, 230, 0.6)" />
            <stop offset="100%" stopColor="rgba(180, 218, 238, 0.65)" />
          </linearGradient>
        </defs>
        <motion.path
          d="M2000,650 Q1600,560 1200,610 T400,590 Q50,580 -300,650 L-300,1000 Q50,910 400,960 T1200,980 Q1600,970 2000,1040 Z"
          fill="url(#seaPurpleTide2)"
          animate={{
            d: [
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(70px)' }}>
        <defs>
          <linearGradient id="seaPinkMintTide3" x1="50%" y1="0%" x2="50%" y2="100%">
            <stop offset="0%" stopColor="rgba(173, 216, 230, 0.7)" />
            <stop offset="45%" stopColor="rgba(200, 220, 255, 0.65)" />
            <stop offset="80%" stopColor="rgba(230, 220, 250, 0.55)" />
            <stop offset="100%" stopColor="rgba(255, 228, 240, 0.5)" />
          </linearGradient>
        </defs>
        <motion.ellipse
          cx="30%" cy="35%" rx="400" ry="250"
          fill="url(#seaPinkMintTide3)"
          animate={{
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ filter: 'blur(75px)' }}>
        <defs>
          <linearGradient id="seaPurpleTide3" x1="50%" y1="100%" x2="50%" y2="0%">
            <stop offset="0%" stopColor="rgba(173, 216, 230, 0.6)" />
            <stop offset="40%" stopColor="rgba(176, 224, 230, 0.55)" />
            <stop offset="70%" stopColor="rgba(200, 220, 255, 0.55)" />
            <stop offset="88%" stopColor="rgba(230, 220, 250, 0.5)" />
            <stop offset="100%" stopColor="rgba(255, 228, 240, 0.45)" />
          </linearGradient>
        </defs>
        <motion.ellipse
          cx="70%" cy="65%" rx="450" ry="280"
          fill="url(#seaPurpleTide3)"
          animate={{
